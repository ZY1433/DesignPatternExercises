...
public class StudentBasicInfo {
	...
	final static String STUDENT_BASIC_INFO = "【作业3.3-1】-外观模式-毕业生信息/src/StudentBasicInfo.txt";
...
//					  System.out.println(name+ " " + bsim.getName()+" "+bsim.getName().equals(name)+"--\n"
//							  +serialNum+" "+bsim.getSerialNum()+" "+ bsim.getSerialNum().equals(serialNum));
