...
public class ClientGUI extends JFrame {
  ...
  public static final String COLLISION = "insurance.Collision Coverage";
  public static final String PERSONINJURE = "Personal Injury Protection";
  public static final String PROPERTY = "insurance.Property Damage Liability";
  public static final String COMPREHENSIVE = "Comprehensive Coverage";
  public static final String LUXERYCARINSURANCE = "豪车保险！";
      ...
      public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getActionCommand().equals(SHOW)) {
		    ...
		    if (type.equals(BODYINJURE)) {
                ...
                pp= new LuxeryCarInsuranceProducer();
            }
